...
namespace AzureServicesForUnity.EventHub
{
    public class EventHubClient : MonoBehaviour
    {
        ...
        //type is https://sureneazx.servicebus.windows.net/temperature/messages
        public string Url = "ENTER YOUR URL HERE";

        //[HideInInspector]
        public string Key = "HDSHzq3XZyH91I+Bob8BZA7zUHWO7X21hh/aqxfeS/o=";

        //[HideInInspector]
        public string KeyName = "TESTSuren"; //depends on the key
