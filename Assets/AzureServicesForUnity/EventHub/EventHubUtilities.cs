...
namespace AzureServicesForUnity.EventHub
{
    public class EventHubUtilities
    {
        public static UnityWebRequest BuildEventHubWebRequest(string url, string method, string json, string key, string keyName)
        {
            ...
            string authorization = "SharedAccessSignature sr=https%3A%2F%2Fsureneazx.servicebus.windows.net%2Ftemperature%2Fmessages&sig=AHQKhxCZDXZUXY695oXdh25Gf8Kbt%2BomiqO3qSvm170%3D&se=1654851126&skn=TESTSuren";
